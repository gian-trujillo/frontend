        ...
        <section className="footer">
            <div className='footer__grid'>
                <div className='footer__grid-heading'>
                    <h4 className='footer__grid-title'>Gian Trujillo.</h4>
                ...
                <div className='footer__grid-list footer__grid-contact'>
                    ...
                    <ul className='footer__list'>
                        ...
                        <li className='footer__list-item'><a href="https://wa.me/528100000000?text=Hola%20Gian,%20me%20gustaría%20recibir%20información%20sobre%20tus%20servicios." className="footer__base-link">+52 81 0000 0000</a></li>
                        <li className='footer__list-item'><a href="mailto:giantrujillo98@gmail.com?subject=Cotización%20para%20evento&body=Hola%20Gian,%20me%20gustaría%20recibir%20información%20sobre%20tus%20servicios." className="footer__base-link">giantrujillo98@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div className='footer__base'>
                <p className='footer__base-text'>© 2026 Gian Trujillo · Todos los derechos reservados</p>
                <div className='footer__base-icons'>
                    ...
                    <a className="footer__base-icon-link" href="mailto:giantrujillo98@gmail.com?subject=Cotización%20para%20evento&body=Hola%20Gian,%20me%20gustaría%20recibir%20información%20sobre%20tus%20servicios."><img src={email} alt="icono de correo electronico" className='footer__base-icon' /></a>
